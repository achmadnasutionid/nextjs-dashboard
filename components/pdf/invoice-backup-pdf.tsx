/**
 * Backup PDF for Invoice – Google Drive sync only.
 * Same information as the general Invoice PDF, but simple layout and StyleSheet-only
...
export type InvoiceBackupPDFData = {
  invoiceId: string
  companyName: string
